...
// FALLBACK ONLY — live hours come from Toast via /api/availability. These mirror
// the café's real Toast schedule (6 AM–8 PM daily) so an outage degrades cleanly.
const HOURS = {
  0: { open: "06:00", close: "20:00" }, // Sun
  1: { open: "06:00", close: "20:00" }, // Mon
  2: { open: "06:00", close: "20:00" }, // Tue
  3: { open: "06:00", close: "20:00" }, // Wed
  4: { open: "06:00", close: "20:00" }, // Thu
  5: { open: "06:00", close: "20:00" }, // Fri
  6: { open: "06:00", close: "20:00" }  // Sat
};
